	...
	; Compiler options:
	;
	; -q --opt=none --chip=18f25k80 -Mdist/default/debug/TP3.X.debug.map \
	; -D__DEBUG=1 --debugger=none -DXPRJ_default=default \
	; -L--defsym=__MPLAB_BUILD=1 --opt=+asmfile --addrqual=ignore -P \
	; --warn=-3 --asmlist --std=c99 --output=+elf:multilocs \
	; --stack=compiled:auto:auto:auto --summary=+xml \
	; --summarydir=dist/default/debug/memoryfile.xml -oTP3.X.debug.elf \
